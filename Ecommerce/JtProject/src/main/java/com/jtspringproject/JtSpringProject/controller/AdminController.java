...
public class AdminController {
	...
	public String userlogin(@RequestParam("username") String username, @RequestParam("password") String pass, Model model) {
		try {
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/springproject","root","Tanishka@28");
	...
	public String updateproduct(@RequestParam("pid") int id,Model model) {
		try {
			...
			if(rst.next()) {
				...
				String pimage = rst.getString(3);
				int pcategory = rst.getInt(4);
				int pquantity = rst.getInt(5);
				int pprice =  rst.getInt(6);
				int pweight =  rst.getInt(7);
				String pdescription = rst.getString(8);
	...
	public String profileDisplay(Model model) {
		try {
			...
			if(rst.next()) {
				...
				String displayusername = rst.getString(2);
				String displayemail = rst.getString("email");
				String displaypassword = rst.getString("password");
				String displayaddress = rst.getString(5);
